...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const ownerNumber ="6285959375675"
        ...
        case '!donasi':
        case '!donate':
            client.sendLinkWithAutoPreview(from, 'https://saweria.co/HAFizhscript', donate)
            break
        case '!tts':
        ...
        case '!bc':
            ...
            for (let ids of chatz) {
                ...
                if (!cvk.isReadOnly) await client.sendText(ids, `[ ES KERING BOT BY HAFIZH ]\n\n${msg}`)
            }
